 ...
 */
public class WeekStackValues extends Fragment{
    ...
    /**
     * Get the Question based on the Week
     */
    private void getWeekBasedQuestions() {
        progressWheel.spin();
        ...
        userCredentials.put(AppConstants.CommonAPI.SORT, AppConstants.CommonAPI.WEEK);
