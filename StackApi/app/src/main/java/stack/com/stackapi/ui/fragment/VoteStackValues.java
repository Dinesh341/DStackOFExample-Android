 ...
 */
public class VoteStackValues extends Fragment{
     ...
     */
    private void getVotesBasedQuestions() {
        progressWheel.spin();
        ...
        userCredentials.put(AppConstants.CommonAPI.SORT, AppConstants.CommonAPI.VOTES);
