 ...
 */
public class MonthlyStackValues extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.vote_stackdatalist, container, false);
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        voteRecyler = (RecyclerView) view.findViewById(R.id.vote_list_recyler);
        voteRecyler.setLayoutManager(new LinearLayoutManager(voteRecyler.getContext()));
        postListAdapter = new QuestionListAdapter();
        voteRecyler.setAdapter(postListAdapter);
        if(AppConstants.isInternetAvailable(getActivity())) {
            getMonthlyBasedQuestions();
        }else{
            Toast.makeText(getActivity(),getString(R.string.internet), Toast.LENGTH_SHORT).show();
        }
    }
    /**
     * Get the Question based on the Monthly
     */
    private void getMonthlyBasedQuestions() {
        progressWheel.spin();
        ...
        userCredentials.put(AppConstants.CommonAPI.SORT, AppConstants.CommonAPI.MONTH);
